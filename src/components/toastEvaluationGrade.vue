...
<template>
  ...
  >
    ...
    <p class="dialog_intro">感谢您参与测评，和掌柜产品须出借人的风险测评等级为{{gradeTxt}}及以上方能认购，您当前的风险测评结果为{{userGrade}}未能达标，请致电和掌柜客服400-020-0178了解详情。</p>
...
export default {
  ...
  methods: {
    ...
    goEvaluation() {
      this.$router.push({ path: "/niskEvaluation" });
    },
    /**
     * 获取用户信息
     */
